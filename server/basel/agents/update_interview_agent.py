...
from basel.tools.update_interviw_question_tool import (
    init_update_interview_question_tool,
)
...
def init_update_interview_agent(current_user: User):
    ...
    update_interview_question_tool = init_update_interview_question_tool(current_user)
