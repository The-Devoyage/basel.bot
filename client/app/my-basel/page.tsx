            ...
            <div className="space-y-3">
              <Alert color="blue" withBorderAccent>
                ...
                <Typography.Paragraph className="dark:text-slate-700">
                  Share your bot with others by simply sharing a link. Employers
                  and recruiters can converse with your bot about you, allowing
                  them to quickly match your skills to a position that is
                  perfect for you.
